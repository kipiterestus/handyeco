    ...
    <section id="reviews" className="pt-4 sm:pt-8 pb-14 sm:pb-20 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-10 text-left">
          <div>
            ...
            <p className="text-base text-slate-600 mt-2 max-w-xl">
              Authentic reviews from Edinburgh homeowners and tenants on Google Maps and MyBuilder. Honest feedback on craftsmanship, punctuality, and spotless tidy work.
            </p>
          </div>

          {/* Dual Score Cards: Google + MyBuilder */}
          <div className="flex flex-wrap items-center gap-3 sm:gap-4">
            
            {/* Google Score Card */}
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-3.5 sm:p-4 shadow-2xs flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <a
                  ...
                  className="text-[11px] font-bold text-blue-600 hover:underline flex items-center gap-0.5 mt-0.5"
                >
                  <span>Google Verified (48)</span>
                  <ExternalLink className="w-3 h-3" />
                </a>
              </div>
            </div>

            {/* MyBuilder Score Card */}
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-3.5 sm:p-4 shadow-2xs flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-amber-500 text-white shadow-2xs flex items-center justify-center shrink-0 font-black text-xs">
                MB
              </div>
              <div className="text-left">
                <div className="flex items-center gap-1.5">
                  <span className="text-lg font-black text-slate-900 leading-none">100%</span>
                  <div className="flex text-amber-400">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-3.5 h-3.5 fill-amber-400" />
                    ))}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[11px] font-bold text-amber-700 hover:underline flex items-center gap-0.5 mt-0.5"
                >
        ...
        <div className="mt-10 sm:mt-14 max-w-3xl mx-auto">
          <div className="bg-gradient-to-r from-blue-50/80 via-white to-amber-50/80 border border-slate-200 rounded-2xl sm:rounded-3xl p-5 sm:p-7 shadow-xs flex flex-col md:flex-row items-center justify-between gap-5 text-center md:text-left">
            <div className="flex items-center gap-4">
              <div className="flex -space-x-2">
                <div className="w-11 h-11 rounded-2xl bg-white shadow-xs border border-slate-200 flex items-center justify-center shrink-0">
                  <svg className="w-5 h-5" viewBox="0 0 24 24">
                    <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" />
                    <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" />
                    <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22.81-.63z" />
                ...
                <div className="w-11 h-11 rounded-2xl bg-amber-500 text-white shadow-xs border-2 border-white flex items-center justify-center shrink-0 font-black text-xs">
                  MB
                </div>
              </div>
              ...
              <div>
                <div className="flex items-center justify-center md:justify-start gap-1.5 text-amber-400">
                  ...
                  <span className="text-slate-900 font-extrabold text-xs ml-1">5.0 Star Rated Tradesperson</span>
                </div>
            ...
            <div className="flex items-center gap-2.5 w-full md:w-auto">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 md:flex-initial inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 shadow-xs transition-all active:scale-95"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 md:flex-initial inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-bold text-slate-900 bg-amber-400 hover:bg-amber-300 shadow-xs transition-all active:scale-95"
              >
                <span>MyBuilder</span>
                <ExternalLink className="w-3.5 h-3.5" />
              </a>

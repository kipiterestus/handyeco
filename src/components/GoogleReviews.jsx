  ...
  return (
    <section id="reviews" className="pt-4 sm:pt-8 pb-14 sm:pb-20 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        {/* Redesigned Premium Google Verified Card below reviews */}
        <div className="mt-10 sm:mt-14 max-w-2xl mx-auto">
          <div className="bg-gradient-to-r from-blue-50/80 via-white to-emerald-50/80 border border-slate-200 rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
            <div className="flex items-center gap-3.5">
              <div className="w-12 h-12 rounded-2xl bg-white shadow-xs border border-slate-200/90 flex items-center justify-center shrink-0">
                <svg className="w-6 h-6" viewBox="0 0 24 24">
                  <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" />
                  <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" />
                  <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22.81-.63z" />
              ...
              <div>
                <div className="flex items-center justify-center sm:justify-start gap-1.5 text-amber-400">
                  ...
                  <span className="text-slate-900 font-extrabold text-xs ml-1">5.0 / 5.0 (48+ Reviews)</span>
                </div>
                <p className="text-xs text-slate-600 mt-0.5 font-medium">
                  100% verified 5-star feedback from Edinburgh homeowners & tenants
                </p>
              </div>
            </div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 shadow-xs hover:shadow-md transition-all shrink-0 active:scale-95"
            >

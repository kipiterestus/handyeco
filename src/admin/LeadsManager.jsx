            ...
            return (
              ...
              >
                ...
                {quote.photos && quote.photos.length > 0 && (
                  <div className="p-2.5 rounded-xl bg-blue-950/20 border border-blue-900/40 space-y-2">
                    <div className="flex items-center justify-between text-[11px] font-bold">
                      <span className="flex items-center gap-1.5 text-blue-400">
                        <FileImage className="w-3.5 h-3.5 text-blue-400" />
                        <span>Eklenen Fotoğraflar ({quote.photos.length})</span>
                      </span>
                      <span className="text-[10px] text-zinc-500 font-normal">Büyütmek için tıkla</span>
                    </div>
                    <div className="grid grid-cols-4 gap-2">
                      {quote.photos.map((photoUrl, pIdx) => (
                        <div
                          key={pIdx}
                          onClick={() => setSelectedImageModal(photoUrl)}
                          className="relative aspect-square rounded-lg overflow-hidden border border-zinc-700 bg-zinc-950 hover:border-blue-500 cursor-pointer group/photo transition-all"
                        >
                          <img
                            src={photoUrl}
                            alt={`Talep fotoğrafı ${pIdx + 1}`}
          ...
          <div className="flex items-center justify-between p-4 sm:p-5 border-b border-zinc-800 shrink-0">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-400">Takvime usta iş kaydı oluşturun</p>
              </div>
            </div>
            <button
              type="button"
          ...
          <div className="flex items-center justify-between p-4 sm:p-5 border-b border-zinc-800 shrink-0">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-400">İş gelir ve giderini kaydedin</p>
              </div>
            </div>
            <button
              type="button"
      ...
      >
        ...
        >
          <div className="flex items-center justify-between p-3 border-b border-zinc-800 bg-zinc-900/80">
            <span className="text-xs font-bold text-zinc-200">Müşteri Yüklenen Fotoğraf Önizlemesi</span>
            <div className="flex items-center gap-2">
              <a
                href={selectedImageModal}
                target="_blank"
                rel="noopener noreferrer"
                className="px-2.5 py-1 text-xs font-semibold text-blue-400 hover:text-blue-300 bg-blue-950/60 border border-blue-900/60 rounded-lg flex items-center gap-1"
              >
          ...
          <div className="p-2 overflow-auto flex items-center justify-center bg-black/60">
            <img

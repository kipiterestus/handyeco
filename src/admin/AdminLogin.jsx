            ...
            <>
              ...
              <form onSubmit={handleTotpSubmit} className="space-y-4">
                <input
                  ...
                  onChange={(e) => setTotpCode(e.target.value.replace(/\D/g, "").slice(0, 6))}
                  autoFocus
                  className="w-full px-4 py-3.5 rounded-xl bg-zinc-900/90 border border-zinc-700/80 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 text-white text-center text-2xl font-mono tracking-[0.5em] placeholder-zinc-600 outline-none transition-all"
                />
                <button
                  type="submit"
                  disabled={loading || totpCode.length !== 6}
